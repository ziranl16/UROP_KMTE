...
def getWord2vec(wrd_list):
    ...
    for wrd in wrd_list:
        if wrd in embed_map:
            embeds[count, :] = np.float32(embed_map[wrd])
        else:
...
coreNLP_url = ['http://10.24.28.106:9006/', 'http://10.24.28.106:9007/', 'http://10.24.28.106:9008/',
               'http://10.24.28.106:9009/', 'http://10.24.28.106:9010/', 'http://10.24.28.106:9011/',
               'http://10.24.28.106:9012/', 'http://10.24.28.106:9013/', 'http://10.24.28.106:9014/',
               'http://10.24.28.106:9015/', 'http://10.24.28.106:9016/']
...
def callnlpServer(text):
    ...
    if res.status_code == 200:
        ...
        print("CoreNLP Error, status code:{}".format(res.status_codet))
